...
public class MD5HashCaseInsensitiveUDF extends BasicHashUDF {

    public MD5HashCaseInsensitiveUDF() throws InternalInitException {
        super("md2sum", DigestAlgorithm.MD5, true);
    }
}
