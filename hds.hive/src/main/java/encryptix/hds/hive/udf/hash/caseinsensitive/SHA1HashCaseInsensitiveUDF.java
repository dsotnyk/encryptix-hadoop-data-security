...
public class SHA1HashCaseInsensitiveUDF extends BasicHashUDF {

    public SHA1HashCaseInsensitiveUDF() throws InternalInitException {
        super("md2sum", DigestAlgorithm.SHA1, true);
    }
}
