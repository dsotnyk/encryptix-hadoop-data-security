...
public class SHA512HashCaseInsensitiveUDF extends BasicHashUDF {

    public SHA512HashCaseInsensitiveUDF() throws InternalInitException {
        super("md2sum", DigestAlgorithm.SHA512, true);
    }
}
