...
public class SHA256HashCaseInsensitiveUDF extends BasicHashUDF {

    public SHA256HashCaseInsensitiveUDF() throws InternalInitException {
        super("md2sum", DigestAlgorithm.SHA256, true);
    }
}
