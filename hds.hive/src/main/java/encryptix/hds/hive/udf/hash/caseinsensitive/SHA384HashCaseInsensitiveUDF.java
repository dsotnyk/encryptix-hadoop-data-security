...
public class SHA384HashCaseInsensitiveUDF extends BasicHashUDF {

    public SHA384HashCaseInsensitiveUDF() throws InternalInitException {
        super("md2sum", DigestAlgorithm.SHA384, true);
    }
}
