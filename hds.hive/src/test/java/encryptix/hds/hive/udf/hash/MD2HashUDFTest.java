...
public class MD2HashUDFTest extends BasicTextUDFTest {

    public MD2HashUDFTest() throws UDFArgumentException, InternalInitException {
        super(new MD2HashUDF());
    }
    ...
    public void happyPathTest() throws HiveException {
        ...
        Assert.assertNotEquals("3c8345b995e1b9bf8bfa4ad97596658b", udfEvaluate("Aaabbb"));
        Assert.assertNotEquals("09b5f457e3b1cf8ca5a321b5df1b003a", udfEvaluate("99Dc60e12d6ea1b454feb55bbe9a64f3"));
    }
