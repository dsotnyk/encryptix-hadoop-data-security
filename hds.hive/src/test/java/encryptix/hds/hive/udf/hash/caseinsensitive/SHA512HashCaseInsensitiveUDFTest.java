...
public class SHA512HashCaseInsensitiveUDFTest extends BasicTextUDFTest {

    public SHA512HashCaseInsensitiveUDFTest() throws UDFArgumentException, InternalInitException {
        super(new SHA512HashCaseInsensitiveUDF());
    }
