...
public class SHA256HashCaseInsensitiveUDFTest extends BasicTextUDFTest {

    public SHA256HashCaseInsensitiveUDFTest() throws UDFArgumentException, InternalInitException {
        super(new SHA256HashCaseInsensitiveUDF());
    }
