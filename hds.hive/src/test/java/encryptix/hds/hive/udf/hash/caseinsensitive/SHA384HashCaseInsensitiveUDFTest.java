...
public class SHA384HashCaseInsensitiveUDFTest extends BasicTextUDFTest {

    public SHA384HashCaseInsensitiveUDFTest() throws UDFArgumentException, InternalInitException {
        super(new SHA384HashCaseInsensitiveUDF());
    }
