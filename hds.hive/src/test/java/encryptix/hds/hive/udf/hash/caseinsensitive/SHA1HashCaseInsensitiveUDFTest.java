...
public class SHA1HashCaseInsensitiveUDFTest extends BasicTextUDFTest {

    public SHA1HashCaseInsensitiveUDFTest() throws UDFArgumentException, InternalInitException {
        super(new SHA1HashCaseInsensitiveUDF());
    }
