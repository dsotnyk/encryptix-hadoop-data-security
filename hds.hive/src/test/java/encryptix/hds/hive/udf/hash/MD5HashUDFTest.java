...
public class MD5HashUDFTest extends BasicTextUDFTest {

    public MD5HashUDFTest() throws UDFArgumentException, InternalInitException {
        super(new MD5HashUDF());
    }
    ...
    public void happyPathTest() throws HiveException {
        ...
        Assert.assertNotEquals("6547436690a26a399603a7096e876a2d", udfEvaluate("Aaabbb"));
        Assert.assertNotEquals("ce148c91996f8645bdb4325fb57918f8", udfEvaluate("99Dc60e12d6ea1b454feb55bbe9a64f3"));
    }
